...
class TestGame(TestCase):
    ...
    def test_player_joins_game(self):
        ...
        game.register_player(self.create_player(second_player_name))
    ...
    def test_game_start(self):
        ...
        self.spectator.notify.assert_called_with(GameStarted())
    ...
    def test_all_prompts_received(self):
        game = WaitForSubmissionsGame(self.host, MOCK_GAME_ID,
        ...
        self.spectator.notify.assert_called_with(NewPrompts(prompts=[first_player_prompt, second_player_prompt]))
    ...
    def test_host_chooses_prompt(self):
        ...
        self.spectator.notify.assert_called_with(StoryUpdate(updated_story))
    ...
    def test_end_of_game(self):
        ...
        self.spectator.notify.assert_called_with(expected_event)
